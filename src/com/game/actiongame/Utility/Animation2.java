 ...
 */
public class Animation2 implements Renderable {
	 ...
	 */
	public Animation2(Image[] frames, int duration) {
	 ...
	 *            The duration to show each frame
	 */
	public Animation2(Image[] frames, int[] durations) {
	 ...
	 *            between renders
	 */
	public Animation2(boolean autoUpdate) {
		currentFrame = 0;
	 ...
	 *            between renders
	 */
	public Animation2(Image[] frames, int duration, boolean autoUpdate) {
	 ...
	 *            between renders
	 */
	public Animation2(Image[] frames, int[] durations, boolean autoUpdate) {
		this.autoUpdate = autoUpdate;
	 ...
	 */
	public Animation2(SpriteSheet frames, int duration) {
	 ...
	 *            the render times
	 */
	public Animation2(SpriteSheet frames, int x1, int y1, int x2, int y2,
	 ...
	 *            The duration each frame should be displayed for
	 */
	public Animation2(SpriteSheet ss, int[] frames, int[] duration) {
		spriteSheet = ss;
		int x = -1;
		int y = -1;
	...
	public Animation2 copy() {
		Animation2 copy = new Animation2();
